        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li v-if="pseudo != ''" class="nav-item d-flex align-items-baseline">
                    <a class="navbar-brand" href="/">{{pseudo}} <img :src="url" alt="" class="btn-md" style="width:25px;  height:25px; border-radius:50%" /> </a>
                    <a class="navbar-brand" v-on:click="logout" href="/">logout</a>
                </li>
